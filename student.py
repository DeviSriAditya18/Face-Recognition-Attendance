...
class Student:
    def __init__(self,root):
        ...
        # First Image
        img=Image.open(r"E:\Big Projects\Face Recognition Attendance System\college_images\s1.jpeg")
        ...
        # Second Image
        img1=Image.open(r"college_images\s2.jpeg")
        ...
        # Third Image
        img2=Image.open(r"college_images\s3.jpeg")
        ...
        img_left=Image.open(r"E:\Big Projects\Face Recognition Attendance System\college_images\s4.jpeg")
        ...
        dep_combo['values']=('Select Department','Computer Science','Management','Commerce')
        dep_combo.current(0)
        ...
        course_combo['values']=('Select Course','MCA','MBA','MCOM','MSC')
        ...
        img_right=Image.open(r"E:\Big Projects\Face Recognition Attendance System\college_images\s5.jpeg")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost',username='root',password='Sriveni@1',database='face_recognizer')
