...
'''class Face_Recognition:
    def __init__(self,root):
        ...
        img_top=Image.open(r"college_images\s7.jpeg")
        ...
        img_bottom=Image.open(r"college_images\s8.jpeg")
...
class Face_Recognition:
    ...
    def face_recog(self):
        def draw_boundary(img, classifier, scaleFactor, minNeighbors, color, text, clf):
            ...
            for (x, y, w, h) in features:
                ...
                try:
                    conn = mysql.connector.connect(host='localhost', username='root', password='Sriveni@1', database='face_recognizer')
                    my_cursor = conn.cursor()
                    my_cursor.execute("SELECT Name, Roll, Dep, `Student id` FROM student WHERE `Student id`=%s", (id,))
        ...
        # Ensure the Haar Cascade file is present
        ...
        # Ensure the classifier file is present
        classifierPath = "classifier.xml"
