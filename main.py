...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        # First Image
        img=Image.open(r"college_images\Stanford.jpeg")
        ...
        # Second Image
        img1=Image.open(r"college_images\face-recognition-AI.jpg")
        ...
        # Third Image
        img2=Image.open(r"college_images\college.jpeg")
        ...
        # Detect Face button
        img5=Image.open(r"college_images\face detect.jpeg")
        ...
        # Train button
        img8=Image.open(r"college_images\Train Data.png")
    ...
    def iExit(self):
        self.iExit=messagebox.askyesno("Face Recognition","Are u sure to exit this project")
        if self.iExit>0:
            self.root.destroy()
        else:
            return
